...
// This gets rid of the contact-form-7 stylesheet
...
//load contact form 7 javascript files only when needed

add_action( 'wp_enqueue_scripts', 'wap8_wpcf7_js', 10 );

function wap8_wpcf7_js() {

     if ( !is_admin() ) {

          // deregister Contact Form 7 js on all pages but the ones we need it on
          if ( class_exists( 'WPCF7_ContactForm' ) ) {
               if ( !is_page( array( 'page-event') ) ) {
